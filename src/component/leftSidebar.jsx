...
const LeftSidebar = () => {
  return (
    <CustomSection  w='20%' b="1px solid yellow" d='flex' fD='column' aI='center'>
      {/* Avatar part start */}
    <CustomBox 
      Width="200px"
       Height="200px" 
