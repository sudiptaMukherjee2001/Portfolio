...
const IntroSection = () => {
    return (
        <CustomSection display="flex"  flexDirection={"column"} alignItems="start" justifyContent={"center"} minHeight="90vh">
            <CustomChip label="Frontend Developer & DevOps Engineer" variant="outlined" />
            <CustomBox mb={"3rem"} fontSize="7xl" gradientLineWidth="15%">
